...
Falcon::Falcon(int x, int y) : Weapon(x, y)
{
	...
	{
		path.PushBack({ 1.0f, 2.0f }, 80, &drop);
		path.PushBack({ 2.0f, 2.0f }, 5, &drop);
		path.PushBack({ 3.0f, 1.5f }, 10, &drop);
	...
	{
		path.PushBack({ 1.0f, 2.0f }, 50, &drop);
		path.PushBack({ 2.0f, 2.0f }, 5, &drop);
		path.PushBack({ 3.0f, 1.5f }, 10, &drop);
		path.PushBack({ 4.0f, 0.0f }, 15, &drop);
		path.PushBack({ 5.0f, 0.0f }, 60, &drop);
	...
	{
		path.PushBack({ 1.0f, 2.0f }, 30, &drop);
		path.PushBack({ 2.0f, 2.0f }, 5, &drop);
		path.PushBack({ 3.0f, 1.5f }, 10, &drop);
		path.PushBack({ 4.0f, 0.0f }, 15, &drop);
		path.PushBack({ 5.0f, 0.0f }, 60, &drop);
	...
	{
		path.PushBack({ 1.0f, 2.0f }, 10, &drop);
		path.PushBack({ 2.0f, 2.0f }, 5, &drop);
		path.PushBack({ 3.0f, 1.5f }, 10, &drop);
		path.PushBack({ 4.0f, 0.0f }, 15, &drop);
		path.PushBack({ 5.0f, 0.0f }, 60, &drop);
	...
	{
		path.PushBack({ 1.0f, 2.0f }, 5, &drop);
		path.PushBack({ 2.0f, 2.0f }, 2.5, &drop);
		path.PushBack({ 3.0f, 1.5f }, 5, &drop);
		path.PushBack({ 4.0f, 0.0f }, 15, &drop);
		path.PushBack({ 5.0f, 0.0f }, 60, &drop);
	}
